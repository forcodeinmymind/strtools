"""
Module for generate unicode strings

Functions
---------

gen_unicode_chars
    Yield unicode characters in given range

export_chars
    export unicode characters in given range

import_chars
    return unicode characters from given file

str_chartable
    Return string with a character table
    Check if there is a matching pygame.freetyp.Font character

print_unicode
    print() unicode characters in giving range
"""
...
def import_chars(filename="unicode.txt") -> str:
    str_chars = str()
...
# string info's
def str_char_table(font=None, str_chars=str()) -> str:
    # -> str()
    str_table = str()
