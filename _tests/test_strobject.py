"""
Module for test module strobject
"""

from strtool import strobject
import pygame
...
print(strobject.str_globals(), "\n")
print(strobject.str_class(test0), "\n")
print(strobject.str_dict(dict_test_0), "\n")
